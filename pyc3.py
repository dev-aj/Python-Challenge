data = '''kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
for i in range(1,len(data)):
    temp = data[i-1:i+8]
    #print(temp)
    if(temp.isalpha() and len(temp) == 9 and temp[0].islower() and temp[8].islower()):
        t1 = temp[1:4]
        t2 = temp[5:8]
        t3 = temp[4]
        if(t1.isupper() and t2.isupper() and t3.islower()):
            print(temp)
            output = output + t3
